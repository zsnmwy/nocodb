...
var MdiAccountGroup = { name: "mdi-account-group", render: render$1 };
const _hoisted_1 = {
  class: "nc-icon",
  preserveAspectRatio: "xMidYMid meet",
  viewBox: "0 0 24 24",
...
var __unplugin_components_0 = { name: "mdi-menu", render };
export { MdiAccountGroup as M, __unplugin_components_0 as _ };
