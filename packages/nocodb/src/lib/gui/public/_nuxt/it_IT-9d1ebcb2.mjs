...
const filterOperation = {
  isEqual: "\xE8 uguale",
  isNotEqual: "non \xE8 uguale",
  isLike: "\xE8 come",
  "isNot like": "non \xE8 come",
  isEmpty: "\xE8 vuoto",
  isNotEmpty: "non \xE8 vuoto",
  isNull: "\xE8 nullo",
  isNotNull: "non \xE8 nullo"
};
const title = {
...
const tooltip = {
  ...
  theme: {
    dark: "C'\xE8 la modalit\xE0 scura (^ \u21E7b)",
    light: "C'\xE8 la modalit\xE0 scura? (^ \u21E7b)"
  },
  addTable: "Aggiungi nuova tabella",
  inviteMore: "Invita pi\xF9 utenti",
...
const msg = {
  info: {
    ...
    shareBasePublic: "Chiunque su Internet con questo link pu\xF2 visualizzare",
    ...
    afterEnablePwd: "L'accesso \xE8 protetto da una password",
    privateLink: "Questa vista \xE8 condivisa tramite un collegamento privato",
    privateLinkAdditionalInfo: "Le persone con collegamento privato possono vedere solo le celle visibili in questa vista",
    afterFormSubmitted: "Dopo che il modulo \xE8 stato inviato",
    ...
    viewNotShared: "La vista corrente non \xE8 condivisa!",
    ...
    lockedView: "Nessuno pu\xF2 modificare la configurazione della vista finch\xE9 non \xE8 sbloccata.",
    ...
    ownerDesc: "Pu\xF2 aggiungere / rimuovere i creatori. E modificare completamente strutture e campi",
    creatorDesc: "Pu\xF2 modificare completamente la struttura e i valori del database.",
    editorDesc: "Pu\xF2 modificare i record ma non pu\xF2 cambiare la struttura del database / dei campi.",
    commenterDesc: "Pu\xF2 visualizzare e commentare i record ma non pu\xF2 modificare nulla",
    viewerDesc: "Pu\xF2 visualizzare i record ma non pu\xF2 modificare nulla",
    ...
    addMultipleUsers: "Puoi aggiungere pi\xF9 e-mail separate da virgole(,)",
  ...
  error: {
    ...
    signUpRules: {
      emailReqd: "L'e-mail \xE8 richiesta",
      emailInvalid: "L'email deve essere valida",
      passwdRequired: "\xC8 richiesta la password",
...
export { activity, datatype, it_IT as default, filterOperation, general, labels, msg, objects, placeholder, title, tooltip };
